Codebook
========
Codebook was generated on 2014-07-21 13:23:22 during the same process that generated the dataset. See `run_analysis.md` or `run_analysis.html` for details on dataset creation.
...
Save data table objects to a tab-delimited text file called `TidyDataHumanActivityRecognitionUsingSmartphones.txt`.


```r
f <- file.path(path, "TidyDataHumanActivityRecognitionUsingSmartphones.txt")
